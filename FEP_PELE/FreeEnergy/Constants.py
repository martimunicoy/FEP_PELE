...
CONTROL_FILE_DICT = {
    ...
    "PARALLEL_PELE_RUNS": INPUT_FILE_KEYS[12],
    "SAFETY_CHECK": INPUT_FILE_KEYS[13],
    "SOLVENT_TYPE": INPUT_FILE_KEYS[14],
    "REMINIMIZE": INPUT_FILE_KEYS[15],
    "RESTART": INPUT_FILE_KEYS[16],
    # List of commands
    "COMMANDS": INPUT_FILE_KEYS[17],
    # PELE control files
    "MIN_CONTROL_FILE": INPUT_FILE_KEYS[18],
    "SIM_CONTROL_FILE": INPUT_FILE_KEYS[19],
    "PP_CONTROL_FILE": INPUT_FILE_KEYS[20],
    "SP_CONTROL_FILE": INPUT_FILE_KEYS[21],
    # Folder names
    "MIN_FOLDER": INPUT_FILE_KEYS[22],
    "SIM_FOLDER": INPUT_FILE_KEYS[23],
    "CAL_FOLDER": INPUT_FILE_KEYS[24],
    # Input PDB path
    "INPUT_PDB": INPUT_FILE_KEYS[25],
    "INITIAL_LIGAND_PDB": INPUT_FILE_KEYS[26],
    "FINAL_LIGAND_PDB": INPUT_FILE_KEYS[27]}
