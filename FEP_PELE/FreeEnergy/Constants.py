...
CONTROL_FILE_DICT = {
    ...
    "SAFETY_CHECK": INPUT_FILE_KEYS[11],
    "SOLVENT_TYPE": INPUT_FILE_KEYS[12],
    "REMINIMIZE": INPUT_FILE_KEYS[13],
    "RESTART": INPUT_FILE_KEYS[14],
    # List of commands
    "COMMANDS": INPUT_FILE_KEYS[15],
    # PELE control files
    "MIN_CONTROL_FILE": INPUT_FILE_KEYS[16],
    "SIM_CONTROL_FILE": INPUT_FILE_KEYS[17],
    "PP_CONTROL_FILE": INPUT_FILE_KEYS[18],
    "SP_CONTROL_FILE": INPUT_FILE_KEYS[19],
    # Folder names
    "MIN_FOLDER": INPUT_FILE_KEYS[20],
    "SIM_FOLDER": INPUT_FILE_KEYS[21],
    "CAL_FOLDER": INPUT_FILE_KEYS[22],
    # Input PDB path
    "INPUT_PDB": INPUT_FILE_KEYS[23],
    "INITIAL_LIGAND_PDB": INPUT_FILE_KEYS[24],
    "FINAL_LIGAND_PDB": INPUT_FILE_KEYS[25]}
