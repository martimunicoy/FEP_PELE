...
CONTROL_FILE_DICT = {
    ...
    # List of commands
    "COMMANDS": INPUT_FILE_KEYS[12],
    # PELE control files
    "MIN_CONTROL_FILE": INPUT_FILE_KEYS[13],
    "SIM_CONTROL_FILE": INPUT_FILE_KEYS[14],
    "PP_CONTROL_FILE": INPUT_FILE_KEYS[15],
    "SP_CONTROL_FILE": INPUT_FILE_KEYS[16],
    # Folder names
    "MIN_FOLDER": INPUT_FILE_KEYS[17],
    "SIM_FOLDER": INPUT_FILE_KEYS[18],
    "CAL_FOLDER": INPUT_FILE_KEYS[19],
    # Input PDB path
    "INPUT_PDB": INPUT_FILE_KEYS[20],
    "INITIAL_LIGAND_PDB": INPUT_FILE_KEYS[21],
    "FINAL_LIGAND_PDB": INPUT_FILE_KEYS[22]}
