...
FROM_FLAGS_TO_NAMES = {
    ...
    CONTROL_FILE_FLAGS[7]: pele_co.CONTROL_FILE_FLAG_NAMES[7],
    CONTROL_FILE_FLAGS[8]: pele_co.CONTROL_FILE_FLAG_NAMES[8]}
...
FROM_NAMES_TO_FLAGS = {
    ...
    pele_co.CONTROL_FILE_FLAG_NAMES[7]: CONTROL_FILE_FLAGS[7],
    pele_co.CONTROL_FILE_FLAG_NAMES[8]: CONTROL_FILE_FLAGS[8]}
